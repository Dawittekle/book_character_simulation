...
class ChatService:
    ...
    def chat(
        ...
        *,
        ...
        if character is None and authenticated_user is None:
        ...
        system_prompt, user_prompt = chat_prompt(
            ...
            factual_memories=self._format_factual_memories(
                authenticated_user,
                character_id,
                text_id,
            ),
        ...
        memories = self._extract_and_store_facts(
            authenticated_user=authenticated_user,
    ...
    def _get_or_create_session(
        ...
        *,
        ...
        if session_id:
            ...
            if existing is None and authenticated_user is None:
    ...
    def _extract_and_store_facts(
        ...
        *,
        ...
        if not existing_memories and authenticated_user is None:
        ...
        try:
            ...
            for fact in extracted_facts.facts:
                ...
                if authenticated_user is None:
                    self.factual_memory_repository.save(memory)
    ...
    def _format_factual_memories(
        ...
        if not memories and authenticated_user is None:
